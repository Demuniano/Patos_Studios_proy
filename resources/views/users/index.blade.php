...
<div class="container text-center">
        ...
        <form action="{{route('users.store')}}" method="post">
            ...
            <input type="text" name="nameUser" placeholder="Juan" id="name" class="form-control mn-3" required>
            ...
            <input type="text" id="emailField"class="form-control mn-3" name="emailUser" placeholder="juan@gmail.com">
